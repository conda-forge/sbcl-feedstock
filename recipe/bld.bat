...
cd %SRC_DIR%\sbcl-source
  ...
  echo "Where?"
  dir "%BUILD_PREFIX%\Library\ucrt64\lib\libzstd.a"
  dir "%BUILD_PREFIX%\Library\ucrt64\bin\libzstd.dll"
  dir "%PREFIX%\Library\ucrt64\lib\libzstd.a"
  dir "%PREFIX%\Library\ucrt64\bin\libzstd.dll"
  set "CC=gcc"
